...
mixin _$TvShows {
  ...
  @JsonKey(name: 'pernalink')
  String get pernalink => throw _privateConstructorUsedError;
...
abstract class $TvShowsCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: 'pernalink') String pernalink,
    ...
    return _then(_value.copyWith(
      name: null == name
          ...
          : name // ignore: cast_nullable_to_non_nullable
              as String,
      pernalink: null == pernalink
          ? _value.pernalink
          : pernalink // ignore: cast_nullable_to_non_nullable
              as String,
...
class _$TvShowsImpl implements _TvShows {
  _$TvShowsImpl(
      ...
      @JsonKey(name: 'pernalink') this.pernalink = '',
  ...
  @override
  String toString() {
    return 'TvShows(name: $name, pernalink: $pernalink, endDate: $endDate, network: $network, imageThumbnailPath: $imageThumbnailPath, status: $status)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.pernalink, pernalink) ||
                other.pernalink == pernalink) &&
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, name, pernalink, endDate,
...
abstract class _TvShows implements TvShows {
  factory _TvShows(
      ...
      @JsonKey(name: 'pernalink') final String pernalink,
